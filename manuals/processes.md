...
Contents grain is **Leadership Confirmed** (Rolf / Deiter / Hans / Heidi / Günter) at `4671ba8` / `02fe95f` (migration `0077`); AC-P2-C1/C2 stay **unsigned** until Tobias clicks. Route stays `test:assign`.
