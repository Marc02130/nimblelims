...
**Current P2 status (2026-09-03):** Named-slot product is on `feat/p2-named-slot` @ `6244bf6` (`0079`). **AC-P2-OQ-WO-8 Pass** (Tobias). **Tobias overall P2 Pass (QA)** 21:26 ET, folding `bf51b19` + `80f054b` + `6244bf6`. **Full Leadership Confirm overall P2 Pass** (Rolf / Deiter / Hans / Heidi / Günter) on the same SHA. Older “overall P2 unsigned” text in historical table rows records those earlier SHAs. This is not a claim that the named-slot product has merged to `main`.
