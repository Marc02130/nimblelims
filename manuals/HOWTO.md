...
**Marc lock (2026-09-01, pending Leadership Confirm) — closeout 1.4 / OQ-WO-8.** **Quantified DNA is the asked-for** (data). **Qubit is the asked-for LimsRun** (analysis_id once; Test `(DNA, Qubit)` is the ask). Other process QC (Nanodrop, …) may sit — other analyses, own Tests, not a second asked-for. Extract stays experiment / equipment; no analysis_id; no boolean `extracted` Result. Do **not** code extract-only zero-LimsRun routes. WGS / WES / ELISA: Qubit stays process QC, not the ask. Send: [`.docs/discussions/2026-09-01-p2-closeout-1-4-quantified-dna.md`](../.docs/discussions/2026-09-01-p2-closeout-1-4-quantified-dna.md). Older “Extracted DNA = tube; zero LimsRuns legal” is pending overwrite. Not IC50.
