...
- Do **not** teach plan-only or dest-only aliquot/pool add from presets. Do **not** teach deleting one half and leaving the other. Do **not** treat Add staying disabled after the pair is gone as the lock (one pair at a time). E-10 UAT §7 is **unsigned** until Tobias. Do **not** restamp dest-container-type §6 (`008baf2`).
