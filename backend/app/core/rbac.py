...
require_schema_edit = require_permission("schema:edit")
require_layout_edit = require_permission("layout:edit")
require_schema_or_layout = require_any_permission(["schema:edit", "layout:edit"])
