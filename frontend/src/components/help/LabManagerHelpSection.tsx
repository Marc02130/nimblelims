...
const LabManagerHelpSection: React.FC = () => {
  ...
  useEffect(() => {
    const fetchHelp = async () => {
      try {
        ...
        // Backend converts "Lab Manager" role name to "lab-manager" slug format
  ...
  return (
    <Box>
      ...
      <Typography 
        ...
        sx={{ mb: 3 }}
      >
        Find answers to common questions about managing laboratory operations in NimbleLIMS. 
        Click on a topic below to learn more.
      </Typography>
      <Box 
        component="nav"
        aria-labelledby="lab-manager-help-heading"
        role="navigation"
      >
...
export default LabManagerHelpSection;
