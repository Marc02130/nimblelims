...
const LabTechHelpSection: React.FC = () => {
  ...
  useEffect(() => {
    const fetchHelp = async () => {
      try {
        ...
        // Backend converts "Lab Technician" role name to "lab-technician" slug format
  ...
  return (
    <Box>
      ...
      <Box 
        component="nav"
        aria-labelledby="lab-tech-help-heading"
        role="navigation"
      >
...
export default LabTechHelpSection;
