...
**Status:** Synced 2026-09-20 (E-10 Met; E-12/E-14 Met; E-7 Met on `4b3609a`; next E-6)  
...
| E-7 | Template `accepted_sample_types` vs product stamp: gate on **experiment / LimsRun**, not entry | Spec/AC12 conflict | **Met** on `feat/e7-type-gate-experiment-limsrun` (`4b3609a`): start uses process-definition step allow-list; template/entry `accepted_sample_types` **422**. UAT §10 **Pass** (Tobias QA, 2026-09-20 13:58 ET); **Rolf Confirm**. Marc owns merge. |
...
4. **E-7** type gate — **Met** on `4b3609a` (UAT §10 Pass; Rolf Confirm; Marc owns merge). **E-6** (intake Available for Testing) — **next**  
5. Docs **E-17–E-19**  
