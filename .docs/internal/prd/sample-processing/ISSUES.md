...
6. **ui-schema-ddl** — UI CREATE TABLE / ADD COLUMN (real Postgres) + table/column (**OQ-1**) + layout (**OQ-2**) + privileges (**OQ-3**) — AI-config foundation; implement gate CLOSED — **next**  
