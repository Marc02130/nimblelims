...
Run: analysis_id + cro_source_id (e.g. CRO-Lab-A)
...
1. **Instrument vs equipment type:** Is “instrument” an instance (LCMS-1) or a type (VendorModel-X)? Prefer **instance or named source** for CRO (“CRO-Lab-A metals export”); types can be a later field.  
