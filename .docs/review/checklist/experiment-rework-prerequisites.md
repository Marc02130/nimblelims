...
- Ensure any rework PR updates `.docs/internal/design/experiment-planning.md`, `README.md` (features section), `manuals/api-endpoints.md`, and UAT scripts.
...
**Docs:** `TODOS.md`, `.docs/internal/design/experiment-planning.md`, `README.md`, `.docs/review/manuals/api-endpoints.md`
