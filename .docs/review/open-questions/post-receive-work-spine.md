...
| OQ-WO-8 | Quantified DNA asked-for: Qubit as the assay LimsRun, or tube-only zero LimsRuns? | **OPEN.** **CEO Confirm 1–6 (Rolf, 2026-09-02)** plus Qubit-reuse punch. Named asked-for LimsRun slot is a **punch pending Leadership Confirm** — **not** part of 1–6, **not** Closed. Leave OPEN until Deiter/Hans/Heidi/Günter stamp. Send: [2026-09-01-p2-closeout-1-4-quantified-dna](../../discussions/2026-09-01-p2-closeout-1-4-quantified-dna.md). | Closeout 1.4 | **CEO Confirm 1–6 (Rolf):** Quantified DNA is an assay ask (data). Qubit is the asked-for LimsRun (exactly one). Wear existing Qubit; do **not** mint a second catalog analysis named Quantified DNA. Test `(DNA, Qubit)` is the ask. Other QC may sit (own analysis_id). Extract stays experiment; no boolean Result. Old 1.4 (zero LimsRuns) **struck**. **422 on 0 LimsRuns is right.** WGS/WES/ELISA: Qubit stays process QC. Tube-only DNA later SKU. Named-slot (Route must name the asked-for LimsRun slot, not any-chain-contains-Qubit) waits Deiter/Hans/Heidi/Günter. No product code. Not overall P2 Pass. | 2026-09-02 | Rolf / pending room |
...
**OQ-WO-7 Closed.** Older “OPEN / AC unsigned until Tobias” copy in walls above is **superseded** — do not restamp those walls. Closeout **1.4** is **OQ-WO-8** (Marc lock, pending Leadership Confirm) — not this Result. Overall P2 remains **unsigned**. Leadership did not stamp overall Pass.
...
## CEO Confirm 1–6 (Rolf) — Quantified DNA / OQ-WO-8 OPEN — 2026-09-02

**CEO Confirm 1–6 (Rolf)** plus Qubit-reuse punch. Docs-only. No product code. Not a UAT Result. Not overall P2 Pass. Not IC50.

This fold punches PR **117** / `3e1856b` back from Full Leadership Confirm. **OQ-WO-8 stays OPEN** until Deiter / Hans / Heidi / Günter stamp. Named asked-for LimsRun slot is a **punch pending Leadership Confirm**. It is **not** part of 1–6. It is **not** OQ-WO-8 Closed.
