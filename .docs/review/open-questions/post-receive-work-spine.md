...
| OQ-TAT-1 | TAT overlap matching when two ranges overlap? | **Decided (provisional) — pending Leadership confirm** | P2 | **409 on save when overlapping TAT, overlapping first-step allow-lists, and overlapping LIMS Run analyses in the chains.** Extract-first vs Qubit-first for the same TAT is legal. Two routes with the same first-step types and different LIMS Run analyses for the same TAT are legal. No first-match. Send: [2026-08-30-p2-route-lock](../../discussions/2026-08-30-p2-route-lock.md). | 2026-08-30 | Marc / Leadership |
