...
| [ai-config-breadth.md](ai-config-breadth.md) | AI config for login, reporting, storage, etc. beyond sample processing | **No** — **Parked** until sample processing closes (north star sequencing 2026-09-20) |
