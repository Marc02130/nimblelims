...
**Reviews:** [CEO](../ceo-review/run-results.md) · [UI](../ui-review/run-results.md) · `.docs/internal/design/run-results.md` · [Security](../security-review/run-results.md)  
**Branch:** `run-results`
...
| 9 | Alias storage / matching? | **Decided** | P0 aliases | **Maintained list on analyte** (no pattern matching). AI assist for misses = **later idea** (`.docs/internal/ideas/ai-analyte-resolution.md`) | 2026-07-11 | Product | EtOH / C2H5OH / ethanol have no pattern |
...
**v1 product policy + implementation complete.** Follow-ons: `.docs/internal/ideas/ai-analyte-resolution.md`, `.docs/internal/ideas/ai-data-import.md`, `.docs/internal/ideas/ai-data-analysis.md`.
...
7. **Method-dev / scratch:** Deferred to `.docs/internal/ideas/orders-and-projects.md` — still use a real analysis (e.g. draft), not null.
...
**Later:** AI-assisted resolution / suggest alias — `.docs/internal/ideas/ai-analyte-resolution.md`.
