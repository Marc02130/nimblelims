...
**AC14 stamp (2026-09-10, `008baf2`, `feat/dest-container-type`, Tobias):** **Pass** — UAT section 6. Browser 6.1 (three separate plan controls; dest container dropdown = Same as source. + 1×1 only; no 96-well / plates) plus live API 6.2–6.8 (entry default, line override / Same as source, template default, `dest_container_type_required` 422, `dest_container_type_not_1x1` 422, no dest-init prompt). See [`UAT_Scripts/uat-extract-hold-dest-type.md`](../../../UAT_Scripts/uat-extract-hold-dest-type.md) section 6. Evidence (cite only): `/workspace/uat-dest-container-type-008baf2-ui61/` and `/workspace/uat-dest-container-type-008baf2/{RESULT.md,tobias-stamp.json,acs.md}`. Does **not** sign 1.7 / AC-P2-C3 / AC-P2-C2.
