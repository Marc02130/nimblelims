...
- Extract-hold dest type / dest **mint** as a P2 C2 result (own stem: aliquot/pool **execute**, not plan submit). Route / Start / map-save / receive / asked-for mint **zero**; dest exists only after execute. P4 must not present that execute as UAT-verified.
