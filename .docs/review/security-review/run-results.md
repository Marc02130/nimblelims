...
**Tech:** `.docs/internal/design/run-results.md`
...
| Start / import / publish without analysis | **No** (blocked for all) | **No** | **No** | **No** |
| Publish + promote | Yes | Yes if **publish** perm (implies result write) | **No** | **No** |
...
Related: [ceo](../ceo-review/run-results.md) · [ui-review](../ui-review/run-results.md) · `.docs/internal/design/run-results.md`
