...
| Idea | Lab ops view |
|------|----------------|
| `.docs/internal/ideas/accessioning-and-workflows-revisit.md` | **Critical next workflow** after entries spine |
| `.docs/internal/ideas/materials-and-lot-tracking.md` | Needed for many SOPs; not blocking this foundation |
| `.docs/internal/ideas/index-sets-and-sequencing-setup.md` | NGS must-have later; experiment_data OK interim |
