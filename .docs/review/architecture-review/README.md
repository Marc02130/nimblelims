...
Engineering architecture reviews of requirements and proposed systems (data model, APIs, migration, trust boundaries at system level).

| Folder | Role |
|--------|------|
| **architecture-review/** (here) | Review verdicts & decisions for a feature packet |
| `.docs/internal/design/` | Longer-form tech design / specs |
