...
| ID | Phase | Notes |
|----|-------|--------|
| AF-WO-* | P2 | Ordered `process_definition[]`; no type picker; map-save 409 only on TAT **and** first-step overlap; zero acceptable 422; two-accept 409; first process starts first; later starts advance/gate; first-start freeze OPEN; publish missing-Test 422 |
