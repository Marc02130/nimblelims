...
**Science (2026-09-01):** Per-AC on `bf51b19` Pass. Overall P2 stayed unsigned. Merged (`5040f2d`) with **OQ-WO-7 OPEN** (WGS params on the DNA Test from the WO after C3). **That click never landed.** Clarifying the issue made the product better. Brief → code → UAT with Pass/Fail and not-a-Fail → stamp → merge. Not IC50.
