...
7. **Multi-tenant readiness** (optional short §) — lab-global now? what stays additive later? See `.docs/internal/ideas/multi-tenant.md`  
...
- Long-form field-management / schema **product** design (platform): `.docs/internal/design/schema-evolution.md` — different from per-cycle deltas  
