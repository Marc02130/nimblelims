...
\restrict t6tKY7prCzVWGSK13kfK3WhMuhI2cHjke12rGuhAi5Yv4k8NuDHVAjOOpMzdhui
...
DROP POLICY IF EXISTS workflow_templates_access ON public.workflow_templates;
...
ALTER TABLE IF EXISTS ONLY public.workflow_templates DROP CONSTRAINT IF EXISTS workflow_templates_modified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.workflow_templates DROP CONSTRAINT IF EXISTS workflow_templates_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.workflow_instances DROP CONSTRAINT IF EXISTS workflow_instances_workflow_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.workflow_instances DROP CONSTRAINT IF EXISTS workflow_instances_status_id_fkey;
ALTER TABLE IF EXISTS ONLY public.workflow_instances DROP CONSTRAINT IF EXISTS workflow_instances_modified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.workflow_instances DROP CONSTRAINT IF EXISTS workflow_instances_created_by_fkey;
...
DROP TRIGGER IF EXISTS workflow_templates_update_modified_at ON public.workflow_templates;
DROP TRIGGER IF EXISTS workflow_templates_audit_timestamps ON public.workflow_templates;
DROP TRIGGER IF EXISTS workflow_instances_update_modified_at ON public.workflow_instances;
DROP TRIGGER IF EXISTS workflow_instances_audit_timestamps ON public.workflow_instances;
...
DROP INDEX IF EXISTS public.idx_workflow_templates_template_definition_gin;
DROP INDEX IF EXISTS public.idx_workflow_templates_active;
DROP INDEX IF EXISTS public.idx_workflow_instances_template_id;
DROP INDEX IF EXISTS public.idx_workflow_instances_status_id;
DROP INDEX IF EXISTS public.idx_workflow_instances_runtime_state_gin;
...
ALTER TABLE IF EXISTS ONLY public.workflow_templates DROP CONSTRAINT IF EXISTS uq_workflow_templates_name;
ALTER TABLE IF EXISTS ONLY public.workflow_instances DROP CONSTRAINT IF EXISTS uq_workflow_instances_name;
...
ALTER TABLE IF EXISTS ONLY public.clients DROP CONSTRAINT IF EXISTS uq_clients_abbreviation;
...
DROP SEQUENCE IF EXISTS public.name_template_seq_sample_sys2600002;
DROP SEQUENCE IF EXISTS public.name_template_seq_sample_sys2600001;
DROP SEQUENCE IF EXISTS public.name_template_seq_sample;
DROP SEQUENCE IF EXISTS public.name_template_seq_project_sys26;
...
DROP FUNCTION IF EXISTS public.has_workflow_template_access();
DROP FUNCTION IF EXISTS public.has_workflow_execute();
...
--
-- Name: has_workflow_execute(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.has_workflow_execute() RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
        BEGIN
            RETURN EXISTS (
...
--
-- Name: has_workflow_template_access(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.has_workflow_template_access() RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
        DECLARE
            user_role_name TEXT;
...
--
-- Name: name_template_seq_project_sys26; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.name_template_seq_project_sys26
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: name_template_seq_sample_sys2600001; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.name_template_seq_sample_sys2600001
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: name_template_seq_sample_sys2600002; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.name_template_seq_sample_sys2600002
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.name_templates (
    ...
    description text,
    seq_padding_digits integer DEFAULT 1 NOT NULL,
    active boolean DEFAULT true NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    created_by uuid,
    modified_at timestamp without time zone DEFAULT now() NOT NULL,
...
CREATE TABLE public.workflow_templates (
    ...
    description text,
    active boolean DEFAULT true NOT NULL,
    template_definition jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    created_by uuid,
    modified_at timestamp without time zone DEFAULT now() NOT NULL,
    modified_by uuid
...
--
-- Name: clients uq_clients_abbreviation; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clients
    ADD CONSTRAINT uq_clients_abbreviation UNIQUE (abbreviation);
...
--
-- Name: workflow_instances uq_workflow_instances_name; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_instances
    ADD CONSTRAINT uq_workflow_instances_name UNIQUE (name);


--
-- Name: workflow_templates uq_workflow_templates_name; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_templates
    ADD CONSTRAINT uq_workflow_templates_name UNIQUE (name);
...
--
-- Name: idx_workflow_instances_created_by; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_instances_created_by ON public.workflow_instances USING btree (created_by);


--
-- Name: idx_workflow_instances_runtime_state_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_instances_runtime_state_gin ON public.workflow_instances USING gin (runtime_state);


--
-- Name: idx_workflow_instances_status_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_instances_status_id ON public.workflow_instances USING btree (status_id);


--
-- Name: idx_workflow_instances_template_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_instances_template_id ON public.workflow_instances USING btree (workflow_template_id);
...
CREATE INDEX idx_workflow_templates_active ON public.workflow_templates USING btree (active);


--
-- Name: idx_workflow_templates_template_definition_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_templates_template_definition_gin ON public.workflow_templates USING gin (template_definition);
...
--
-- Name: workflow_instances workflow_instances_audit_timestamps; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER workflow_instances_audit_timestamps BEFORE INSERT OR UPDATE ON public.workflow_instances FOR EACH ROW EXECUTE FUNCTION public.set_audit_timestamps();


--
-- Name: workflow_instances workflow_instances_update_modified_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER workflow_instances_update_modified_at BEFORE UPDATE ON public.workflow_instances FOR EACH ROW EXECUTE FUNCTION public.update_modified_at_column();


--
-- Name: workflow_templates workflow_templates_audit_timestamps; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER workflow_templates_audit_timestamps BEFORE INSERT OR UPDATE ON public.workflow_templates FOR EACH ROW EXECUTE FUNCTION public.set_audit_timestamps();


--
-- Name: workflow_templates workflow_templates_update_modified_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER workflow_templates_update_modified_at BEFORE UPDATE ON public.workflow_templates FOR EACH ROW EXECUTE FUNCTION public.update_modified_at_column();
...
--
-- Name: workflow_instances workflow_instances_modified_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_instances
    ADD CONSTRAINT workflow_instances_modified_by_fkey FOREIGN KEY (modified_by) REFERENCES public.users(id);


--
-- Name: workflow_instances workflow_instances_status_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_instances
    ADD CONSTRAINT workflow_instances_status_id_fkey FOREIGN KEY (status_id) REFERENCES public.list_entries(id);
...
--
-- Name: workflow_templates workflow_templates_modified_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_templates
    ADD CONSTRAINT workflow_templates_modified_by_fkey FOREIGN KEY (modified_by) REFERENCES public.users(id);
...
CREATE POLICY clients_access ON public.clients USING (((public.is_admin() = true) OR (EXISTS ( SELECT 1
   FROM public.users u
  WHERE ((u.id = public.current_user_id()) AND (u.client_id = '00000000-0000-0000-0000-000000000001'::uuid)))) OR (EXISTS ( SELECT 1
   FROM public.users u
  WHERE ((u.id = public.current_user_id()) AND (u.client_id IS NOT NULL) AND (u.client_id <> '00000000-0000-0000-0000-000000000001'::uuid) AND (u.client_id = clients.id))))));
...
--
-- Name: workflow_instances workflow_instances_access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY workflow_instances_access ON public.workflow_instances USING ((public.is_admin() OR (created_by = public.current_user_id()) OR public.has_workflow_execute()));
...
--
-- Name: workflow_templates workflow_templates_access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY workflow_templates_access ON public.workflow_templates USING (public.has_workflow_template_access());
...
\unrestrict t6tKY7prCzVWGSK13kfK3WhMuhI2cHjke12rGuhAi5Yv4k8NuDHVAjOOpMzdhui
