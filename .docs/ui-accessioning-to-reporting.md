...
This document describes the user interface components and interactions for the accessioning through reporting workflow in the LIMS MVP. The UI is built with React and Material-UI (MUI), using Formik for form management and Yup for validation.
