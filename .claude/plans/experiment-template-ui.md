...
**Doc alignment:** README, `.docs/review/manuals/navigation.md`, `.docs/review/manuals/api-endpoints.md`, local `.docs/internal/design/experiment-planning.md` (not committed), backend/frontend READMEs, and `UAT_Scripts/uat-experiment-templates.md` describe the shipped behavior.
