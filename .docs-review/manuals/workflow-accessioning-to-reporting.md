...
**API (summary)** — see `.docs-review/manuals/api-endpoints.md` for detail:
...
**Further reading**: `.docs-internal/design/experiment-planning.md`, `.docs-review/manuals/navigation.md`.
